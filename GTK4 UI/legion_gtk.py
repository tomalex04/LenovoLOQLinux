...
class FanCurveWidget(Gtk.DrawingArea):
    SNAP = [round(i * 128 / 11) for i in range(12)]
    MAX_PWM = 128
    _RPM_MAP = {0: 1400, 12: 1700, 23: 1700, 35: 1700, 47: 1900, 58: 2300, 70: 2800, 81: 3200, 93: 3700, 105: 4200, 116: 4600, 128: 5000}
    DEFAULTS = [
        [60, 42, 47], [64, 48, 47], [68, 54, 58], [72, 60, 58],
        [76, 66, 70], [80, 72, 70], [84, 80, 81], [88, 88, 81],
        [93, 94, 93], [98, 99, 105]
    ]
